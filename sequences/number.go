...
func Modify[T any](fn func(T) T, s func(T) bool) func(T) bool {
	return func(c T) bool {
		return s(fn(c))
	}
}

func Invert[T any](s func(T) bool) func(T) bool {
	return func(c T) bool {
		return !s(c)
	}
}

func StartStriper[T Ordered](d T) func(T) bool {
	return func(c T) bool {
		return c < d
	}
}
...
func MultiStriper[T any](ss ...func(T) bool) func(T) bool {
	return func(c T) bool {
		for _, s := range ss {
			if s(c) {
				return true
